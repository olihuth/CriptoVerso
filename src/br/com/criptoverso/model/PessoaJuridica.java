...
public class PessoaJuridica extends Usuario{
    ...
    public PessoaJuridica(int cd_usuario, int email, String senha, String nm_usuario, int nr_telefone, int nr_ddd, Endereco endereco, int nr_cnpj, String nm_fantasia) {
