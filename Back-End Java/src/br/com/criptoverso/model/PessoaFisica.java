...
public class PessoaFisica extends Usuario{
    ...
    public PessoaFisica(int cd_usuario, String email, String senha, String nm_usuario, String nr_telefone, int nr_ddd, Endereco endereco, int nr_cpf, String dt_nascimento) {
    ...
    public PessoaFisica(int cd_usuario, String email, String senha, String nm_usuario, String nr_telefone,
    		int nr_cpf, String dt_nascimento) {
